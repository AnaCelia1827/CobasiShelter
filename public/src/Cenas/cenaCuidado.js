...
pulga.setActive(true)
pulga.setVisible(true)
...
pulga.setActive(false)
pulga.setVisible(false)

if(pulga.body){
pulga.body.enable = false
}

this.pulgasRemovidas++
this.pontuacao++

this.textoProgresso.setText(
`Pulgas:${this.pulgasRemovidas}/${this.totalPulgas}`
)
...
gameState.barras.limpeza - 10,0,11
)
